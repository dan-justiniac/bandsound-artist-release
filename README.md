...
[BandSound Artist — macOS preview (unsigned, unnotarized)](https://github.com/dan-justiniac/bandsound-artist-release/releases/download/0.1.0-preview/BandSound-Artist-0.1.0-preview-mac-universal.dmg)
